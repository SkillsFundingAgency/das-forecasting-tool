...
namespace SFA.DAS.Forecasting.PreLoad.Functions
{
    ...
    public class LevyDeclarationNoProjectionPreLoadFunction : IFunction
    {
        ...
        public static async Task Run(
            ...
            TraceWriter writer)
        {
            await FunctionRunner.Run<LevyDeclarationNoProjectionPreLoadFunction>(writer, executionContext,
