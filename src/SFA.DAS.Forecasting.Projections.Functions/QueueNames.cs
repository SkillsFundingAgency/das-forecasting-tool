namespace SFA.DAS.Forecasting.Projections.Functions
{
    public class QueueNames
    {
        ...
        public const string GeneratePaymentTotals = "forecasting-projections-build-payment-totals";
        public const string GetAccountBalance = "forecasting-projections-get-account-balance";
        public const string GenerateProjectionForAllAccounts = "forecasting-projections-generate-all-projections";
    }
}