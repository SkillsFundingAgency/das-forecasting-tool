...
{
	public class EmployerDataService : BaseRepository, IEmployerPaymentDataService
	{
		public EmployerDataService(string connectionString, ILog logger) : base(connectionString, logger)
		{
		}
