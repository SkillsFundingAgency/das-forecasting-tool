...
public class GetApplicationsTests
{
    ...
    public async Task GetApplications_Returns_Applications_For_Pledge()
    {
        ...
        {
            var actualApplication = _apiResponse.Applications[index];
            AssertEquality(expectedApplication, actualApplication);
            index++;
        }
    }

    private static void AssertEquality(GetApplicationsResponse.Application expected, GetApplicationsResponse.Application actual)
    {
