...
namespace SFA.DAS.Forecasting.Web.AcceptanceTests.StepDefinition
{
    ...
    public class DownloadForecastBalanceSheetSteps : StepsBase 
    {
        ...
        public void ThenColumnHeadersAreDownloaded()
        {
            ...
            Assert.True(readCsvHeader.Contains("Start Date,End Date,Apprenticeship,Apprenticeship Level,Transfer to Employer,Uln,Apprentice Name,UKPRN,Provider Name,Total Cost,Monthly Training Cost,Completion Amount"), "ERROR: File header titles is {0}", readCsv.First());
