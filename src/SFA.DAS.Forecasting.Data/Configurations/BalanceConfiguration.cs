...
namespace SFA.DAS.Forecasting.Data.Configurations
{
    ...
    public partial class BalanceConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BalanceModel>
    {
        ...
        public BalanceConfiguration(string schema)
        {
            ...
            Property(x => x.TransferAllowance).HasColumnName(@"TransferAllowance").HasColumnType("decimal").IsRequired().HasPrecision(18,5);
            Property(x => x.RemainingTransferBalance).HasColumnName(@"RemainingTransferBalance").HasColumnType("decimal").IsRequired().HasPrecision(18,5);
